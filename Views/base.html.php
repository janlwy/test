...
<body class="clair-theme" id="themeBody">
	...
	<main>
		<?php if (isset($_SESSION['pseudo']) && isset($_SESSION['user_id']) && !in_array($_GET['url'], ['accueil/index', 'creation/createUserForm', 'connexion/createUserForm', 'connexion/connectForm'])): ?>
